                                        ...
                                        <td align='left' style='font-size:0px;padding:0px;word-break:break-word;'>
                                          <table border='0' cellpadding='0' cellspacing='0' style='cellpadding:0;cellspacing:0;color:#000000;font-family:Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:100%;' width='100%'>
                                            <tr>
                                              <td align='left'>
                                                <a href='#'>
                                                  <img align='left' alt='Logo' padding='5px' src='' width='200' />
                                                </a>
                                              </td>
                    ...
                    <tr>
                      <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                        <div style='color:#777777;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;line-height:21px;text-align:left;'>
                          Here's the credentials for your account: 
                          <ul style="list-style-type: none">
                            <li>
                              <strong>Username: </strong><span style="font-weight: bolder;">{{ $details['email'] }}</span>
                            </li>
                            <li>
                              <strong>Password: </strong><span style="font-weight: bolder;">{{ $details['password'] }}</span>.
                            </li>
                            <li>
                        ...
                        <table border='0' cellpadding='0' cellspacing='0' role='presentation' style='border-collapse:separate;line-height:100%;'>
                          <tr>
                            <td align='center' bgcolor='#ff6f6f' role='presentation' style='background-color:#0081b8;border:none;border-radius:5px;cursor:auto;padding:10px 25px;' valign='middle'>
                              <a href='#' style='background:#0081b8;color:#ffffff;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;font-weight:400;line-height:21px;margin:0;text-decoration:none;text-transform:none;' target='_blank'>
                                Visit Site
                              </a>
                            </td>
                          </tr>
